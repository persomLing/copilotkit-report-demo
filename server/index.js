...
const agent = new BuiltInAgent({
  ...
  instructions: [
    ...
    "前端上下文里的 learningMemory 分两层：userPreferences/userCorrections/userHabits 是当前用户记忆，只能作为个人偏好参考；approvedSystemRules 是已经人工确认的通用规则，可以用于后续判断；pendingRuleCandidates 只是待审核候选，不能当作事实执行。",
